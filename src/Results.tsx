  ...
  return (
    <Fragment>
      <div className="grid grid-flow-col auto-cols-max h-48">
        <div className="shadow-md rounded m-4 text-3xl font-bold center-flex px-12 bg-gray-300">
        ...
        {current?.temp_f ? (
          <div className="shadow-md rounded m-4 text-3xl font-extrabold center-flex px-12 bg-gray-300">
