...
const About = () => {
  return (
    <div className="shadow-md rounded m-4 p-8 bg-gray-300">
        ...
        <p>It is my personal policy to become highly utlized by whatever team I am working with. The downside of that is I spend so much time on proprietary projects and stacked responsbilities that it leaves me very little time and energy to create portfolio type material such as this!</p>
        <p className="max-w-md">These days I am into full-stack JS approaches, using NextJS & ExpressJS. I have also taken a strong interest in creating Design Systems with React/Storybook/Figma. My favorite experience and preference for creating a web front-end is React although I have built some stuff with Angular and Vue.</p>
        </div>
    </div>
  );
};
